...
data class HttpDependencies(
     ...
     */
    fun protocolTestDependency(
        runtimeConfig: software.amazon.smithy.rust.codegen.core.smithy.RuntimeConfig,
    ): software.amazon.smithy.rust.codegen.core.rustlang.CargoDependency {
